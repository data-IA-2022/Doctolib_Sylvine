...
class medData(models.Model):
    ...
    anonymousID = models.ForeignKey(Utilisateur, null= True, on_delete = models.CASCADE)# trouver moyen pour remplir auto avec l'ID avec la table correspondance avec username
